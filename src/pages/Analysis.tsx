  ...
  const [analysisTypes] = useState([
    {
      ...
      path: '/analysis/upload?type=fracture-detection',
      color: 'bg-red-100 text-red-600',
      disabled: false,
      prompt: isDoctor(user) ? task_prompts['fracture-detection'].doctor : task_prompts['fracture-detection'].common
    },
    {
      id: 'osteoporosis',
    ...
    },
    {
      ...
      path: '/analysis/upload?type=osteoarthritis',
      color: 'bg-blue-100 text-blue-600',
      disabled: true,
      prompt: isDoctor(user) ? task_prompts['osteoarthritis'].doctor : task_prompts['osteoarthritis'].common
    },
    {
      id: 'bone-marrow',
      ...
      path: '/analysis/upload?type=bone-marrow',
      color: 'bg-purple-100 text-purple-600',
      disabled: true,
      prompt: isDoctor(user) ? task_prompts['bone-marrow'].doctor : task_prompts['bone-marrow'].common
    },
    {
      id: 'bone-age',
      ...
      path: '/analysis/upload?type=bone-age',
      color: 'bg-green-100 text-green-600',
      disabled: true,
      prompt: isDoctor(user) ? task_prompts['bone-age'].doctor : task_prompts['bone-age'].common
    },
    {
      id: 'spine-fracture',
      ...
      path: '/analysis/upload?type=spine-fracture',
      color: 'bg-indigo-100 text-indigo-600',
      disabled: true,
      prompt: isDoctor(user) ? task_prompts['spine-fracture'].doctor : task_prompts['spine-fracture'].common
    },
    {
      id: 'bone-tumor',
      ...
      path: '/analysis/upload?type=bone-tumor',
      color: 'bg-rose-100 text-rose-600',
      disabled: true,
      prompt: isDoctor(user) ? task_prompts['bone-tumor'].doctor : task_prompts['bone-tumor'].common
    },
    {
      id: 'bone-infection',
      ...
      path: '/analysis/upload?type=bone-infection',
      color: 'bg-teal-100 text-teal-600',
      disabled: true,
      prompt: isDoctor(user) ? task_prompts['bone-infection'].doctor : task_prompts['bone-infection'].common
    }
  ]);
