    ...
    <div className="container mx-auto px-4 py-12 animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-fade-in">
          <Card className="col-span-1 border shadow-sm transition-all duration-300 hover:shadow-xl transform hover:translate-z-0 hover:scale-103 rounded-lg">
            <CardHeader>
            ...
            <CardContent>
              <div className="space-y-2 max-h-[600px] overflow-y-auto pr-2">
                {analyses.map((analysis) => (
                  <div
                    key={analysis.id}
                    className={`p-3 rounded-md cursor-pointer transition-colors hover:bg-muted/80 transition-all duration-200 hover:shadow-md transform hover:translate-z-0 hover:scale-101`}
