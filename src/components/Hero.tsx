...
const Hero = () => {
  return <section className="relative min-h-[90vh] flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Features */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 mt-20 animate-fade-in-up" style={{
        animationDelay: '0.4s'
      }}>
          ...
          <div className="p-6 rounded-xl glass-card backdrop-blur-xs hover:shadow-md transition-all duration-300">
            ...
            <p className="text-muted-foreground text-center">Predict osteoporosis stages and calculate bone mineral density and many more such analysis</p>
          </div>
